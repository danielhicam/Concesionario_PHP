...
$id_vendedor = ($_SESSION['tipo_usuario'] === "vendedor") ? $_SESSION['id_usuario'] : "NULL";

$sql = "INSERT INTO coches (modelo, marca, color, precio, alquilado, foto, id_usuario, id_vendedor) 
        VALUES ('$modelo', '$marca', '$color', '$precio', '0', '$foto', '$id_usuario', $id_vendedor)";
