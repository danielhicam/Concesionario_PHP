...
.claseR .clase3 a {color: #fff; text-decoration: none;}.formulario {background-color: rgba(34, 34, 34); padding: 30px; border-radius: 10px; width: 60%; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color: #eaeaea; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.5);}
