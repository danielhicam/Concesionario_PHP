...
.clase6 a {display: block; padding: 10px 0; text-decoration: none; color: #d6cfc7; font-size: 16px; font-family: 'Raleway', sans-serif; transition: background-color 0.3s ease, color 0.3s ease;}
.clase6 a:hover {background-color: #b3a99b; color: #111;}
</style>
</head>
<body>
